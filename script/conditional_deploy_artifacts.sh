...
artifact_path="artifacts/script/${git_hash_last_commit}.pdf"
...
while true; do
	...
	(git fetch ${deployment_remote_name} && git checkout ${deployment_remote_name}/${git_branch_artifacts} --) || quit 4
